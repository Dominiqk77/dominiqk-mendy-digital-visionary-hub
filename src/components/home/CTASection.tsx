...
const CTASection = () => {
  return <section className="py-20">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="mx-auto rounded-2xl overflow-hidden border-gradient border-gradient-strong">
          <div className="relative bg-gradient-to-r from-gray-900 to-black p-12 md:p-16">
            ...
            {/* Updated gradient class name to match new color scheme */}
            <div className="absolute inset-0 opacity-5 portfolio-gradient"></div>
