...
const testimonials = [
  ...
  },
  {
    ...
    position: "CEO",
    quote: "Notre collaboration avec Dominiqk a été un véritable tournant pour Publi Ticket. Sa vision novatrice et sa compréhension approfondie du marché digital marocain nous ont permis de nous démarquer considérablement.",
  ...
  },
  {
    id: 4,
    name: "Amélie Lefèvre",
    company: "Digital Afrique Consultants",
    position: "Responsable Innovation",
    quote: "Dominiqk a su apporter des solutions sur mesure pour notre transition digitale. Son approche holistique et sa compréhension des enjeux locaux ont fait toute la différence. Je recommande vivement ses services à toute entreprise cherchant à innover.",
  ...
  },
  {
    id: 6,
    name: "Claire Dubourg",
    company: "Alliance Numérique Maghreb",
    position: "Présidente",
    quote: "Dominiqk a orchestré notre transformation numérique avec brio. Son expertise en IA et sa connaissance du marché africain ont permis à notre consortium de devenir un leader régional en moins d'un an.",
  ...
  },
  {
    ...
    quote: "Working with Dominiqk was a game-changer for our startup ecosystem in Kenya. His insights into emerging technologies and market trends provided us with a roadmap that attracted significant investment and international partnerships.",
  ...
  },
  {
    ...
    company: "African Development Coalition",
    position: "Project Lead",
    quote: "Dominiqk's contribution to our digital governance project was invaluable. He successfully bridged technical expertise with cultural sensitivity, resulting in a solution that was readily adopted across several West African nations.",
  ...
  },
  {
    id: 11,
    name: "James Wilson",
    company: "EuroAfrica Tech Partners",
    position: "Strategy Officer",
    quote: "Dominiqk's dual expertise in European and African markets makes him an invaluable consultant. His strategic guidance helped us navigate complex regulatory environments and establish successful digital partnerships across both continents.",
  ...
  },
  {
    ...
    quote: "Dominiqk's deep understanding of AI implementation in diverse markets helped us develop culturally-sensitive algorithms that outperformed our previous models by 60%. His expertise is truly global in scope.",
  ...
  },
  {
    ...
    quote: "We engaged Dominiqk to evaluate digital opportunities across emerging African markets. His insights were spot-on and led to several successful ventures that continue to yield impressive returns for our portfolio.",
  ...
  // Spanish testimonials
  {
    ...
    quote: "La colaboración con Dominiqk ha sido transformadora para nuestra empresa. Su enfoque estratégico en inteligencia artificial y su comprensión de múltiples mercados nos permitió expandirnos exitosamente en África y Europa.",
  ...
  },
  {
    ...
    quote: "Dominiqk aportó una perspectiva única a nuestros proyectos en Latinoamérica y África. Su habilidad para adaptar soluciones tecnológicas a diferentes contextos culturales fue clave para nuestro éxito internacional.",
  ...
  },
  {
    ...
    quote: "El conocimiento de Dominiqk sobre mercados emergentes y tecnologías disruptivas nos proporcionó una ventaja competitiva significativa. Su enfoque práctico y orientado a resultados generó impactos inmediatos en nuestro negocio.",
  ...
  },
  {
    ...
    company: "Soluciones Globales Latam",
  ...
  },
  {
    id: 19,
    name: "Sofía Ramírez",
    company: "Consultora Digital Andina",
    position: "Gerente de Proyectos",
    quote: "La visión multicultural de Dominiqk fue fundamental para el éxito de nuestros proyectos en África. Sus soluciones tecnológicas consideran aspectos culturales y sociales que otros consultores suelen pasar por alto.",
