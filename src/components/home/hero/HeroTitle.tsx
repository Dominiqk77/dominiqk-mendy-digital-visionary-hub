      ...
      <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold leading-tight font-montserrat tracking-tighter">
        ...
        <div className="mt-4 flex flex-col items-center md:items-start">
          ...
          <div className="relative mt-2 overflow-hidden">
            <span className="font-poppins text-gradient-cosmic bg-gradient-to-r from-portfolio-blue via-portfolio-purple to-portfolio-pink bg-clip-text text-transparent text-3xl sm:text-4xl md:text-5xl font-bold relative z-10 animate-slide-in-right" style={{
            animationDelay: "0.3s"
          }}>
