...
const HeroTitle = () => {
  ...
  return (
    ...
    >
      <motion.div 
        className="flex justify-center md:justify-start mb-4" // Centered on mobile, left-aligned on desktop
        variants={itemVariants}
      >
        <div className="inline-block px-4 py-1.5 bg-portfolio-purple/10 backdrop-blur-sm rounded-full text-portfolio-purple border border-portfolio-purple/20 text-sm font-medium">
