                  ...
                  {item.dropdown ? (
                    <>
                      <button 
                        ...
                        className="w-full flex justify-between items-center px-3 py-2 text-base font-medium rounded-md hover:bg-gray-100 animate-gradient-slow"
                      >
                        <span>{item.name}</span>
                      ...
                      {activeDropdown === item.name && (
                        <div className="pl-4 space-y-1 animate-fade-in bg-gray-50/90 backdrop-blur-sm rounded-md mt-1 mb-2">
                          {item.children?.map((child) => (
                            <Link
                              key={child.name}
                              to={child.href}
                              className="block px-3 py-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-primary rounded-md animate-gradient-slow"
