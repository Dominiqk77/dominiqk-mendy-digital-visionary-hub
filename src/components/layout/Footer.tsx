...
const Footer = () => {
  return (
    <footer className="relative z-10 border-t border-white/10 bg-black/50 backdrop-blur-sm">
      {/* Add nebula effects for consistent space theme */}
      <div className="nebula-glow-purple w-64 h-64 bottom-10 right-10 opacity-20"></div>
      <div className="nebula-glow-blue w-80 h-80 top-0 left-20 opacity-20"></div>
