      ...
      <main className="flex-grow pt-20 relative z-10">
        ...
        <section className="space-bg-gradient py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-3xl mx-auto text-center">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-indigo-500 rounded-full filter blur-[100px] opacity-30"></div>
              ...
              >
                <span className="bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-gradient-slow inline-block py-2 px-4 rounded-lg shadow-[0_0_15px_rgba(123,97,255,0.3)] backdrop-blur-sm">
                  Portfolio
                </span>
              </motion.h1>
              ...
              <motion.p 
                ...
                className="text-xl md:text-2xl mb-10 text-gray-200 relative z-10 text-shadow-lg"
              >
              ...
              <div className="relative">
                ...
                >
                  <div className="animate-ping absolute h-full w-full rounded-full bg-indigo-400 opacity-30"></div>
                  <Star className="relative h-10 w-10 text-indigo-400 opacity-70" />
                </motion.div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 md:py-20 relative">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-600 bg-clip-text text-transparent inline-block">
          ...
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              <motion.h2 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8 }}
                className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-indigo-300 to-purple-400 bg-clip-text text-transparent shadow-glow"
              >
