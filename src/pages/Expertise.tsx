...
import { Check, Award, Bookmark, Zap, BookOpen, Lightbulb, Server, Database, CircuitBoard, Atom, Star, Layers, Code, Globe, PieChart, BarChart3, LineChart, TrendingUp, BrainCircuit, Cpu, Network, ShieldCheck, Smartphone, LucideIcon, Monitor, Palette, Users, MessageSquare, Share2, FileText, Rocket, Building, PenTool, Briefcase, TreePine } from 'lucide-react';
...
const NebulaBg = () => {
  return <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      <div className="absolute top-0 left-0 w-full h-full opacity-10">
        <div className="absolute top-[10%] left-[10%] w-[70%] h-[60%] rounded-full bg-indigo-500/30 blur-[120px] animate-float" style={{
        animationDuration: '15s'
      }}></div>
        <div className="absolute top-[30%] right-[20%] w-[40%] h-[50%] rounded-full bg-purple-500/20 blur-[100px] animate-float" style={{
        animationDuration: '20s',
        animationDelay: '2s'
      }}></div>
        <div className="absolute bottom-[10%] left-[30%] w-[60%] h-[40%] rounded-full bg-blue-500/20 blur-[150px] animate-float" style={{
...
const TechNodes = () => {
  ...
  return <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <div className="absolute inset-0 opacity-25">
        {points.map(point => <motion.div key={point.id} className="absolute w-2 h-2 bg-portfolio-blue rounded-full" style={{
        left: `${point.x}%`,
        top: `${point.y}%`,
        width: `${point.size}px`,
...
const FuturisticGrid = () => {
  return <div className="absolute inset-0 tech-grid opacity-10 pointer-events-none"></div>;
};
...
const DataFlowAnimation = () => {
  return <div className="absolute inset-0 pointer-events-none z-0">
      <div className="absolute inset-0 data-grid">
        {[...Array(10)].map((_, i) => <div key={i} className="absolute w-px h-20 bg-gradient-to-b from-portfolio-blue/0 via-portfolio-blue/30 to-portfolio-blue/0" style={{
        left: `${10 + i * 8}%`,
        top: '0%',
        animation: `data-flow ${3 + i * 0.5}s infinite linear`,
        animationDelay: `${i * 0.7}s`
      }} />)}
        {[...Array(10)].map((_, i) => <div key={i} className="absolute w-px h-20 bg-gradient-to-b from-portfolio-purple/0 via-portfolio-purple/20 to-portfolio-purple/0" style={{
        right: `${15 + i * 9}%`,
        top: '0%',
...
const Expertise = () => {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Découvrez l\'expertise de Dominiqk Mendy en innovation numérique, intelligence artificielle, développement web, marketing digital et transformation digitale pour entreprises Africaines.');
    }
  ...
  const expertiseAreas: ExpertiseItem[] = [{
    ...
    points: ["Modèles prédictifs et analytiques", "Traitement du langage naturel (NLP)", "Vision par ordinateur", "Systèmes de recommandation", "Optimisation par IA"],
    ...
    points: ["Applications web progressives (PWA)", "Applications mobiles natives et hybrides", "Sites e-commerce et marchés virtuels", "Systèmes de paiement mobile", "Architectures cloud et serverless"],
    ...
    points: ["SEO/SEM adapté aux marchés africains", "Campagnes publicitaires multicanales", "Stratégies de contenu et d'influence", "Marketing d'automation et CRM", "Analyse de données et optimisation"],
    ...
    points: ["Portails de services citoyens", "Systèmes de gestion documentaire", "Solutions de participation citoyenne", "Sécurisation des données publiques", "Formation des fonctionnaires"],
    ...
    points: ["Bootcamps technologiques intensifs", "Formations IA pour décideurs", "Programmes d'accompagnement startup", "Certification en développement web", "Ateliers design thinking"],
    techStat: `${techStats.clientSatisfaction}% satisfaction`,
    category: 'business'
  }, {
    id: 'consulting',
    ...
    points: ["Audit et stratégie numérique", "Accompagnement à la transformation", "Innovation technologique adaptée", "Développement de produits digitaux", "Internationalisation et scaling"],
    ...
    points: ["Réseaux de neurones convolutifs (CNN)", "Réseaux de neurones récurrents (RNN)", "Apprentissage par renforcement", "Transformers et BERT", "Transfer learning"],
    techStat: `${techStats.aiAccuracy}% précision`,
    category: 'ai'
  }, {
    id: 'nlp',
    ...
    points: ["Chatbots multilingues", "Analyse de sentiment", "Extraction d'informations", "Traduction automatique", "Résumé automatique de texte"],
    ...
    points: ["React, Vue.js, Angular", "Interfaces mobiles réactives", "State management avancé", "Animations et transitions", "Tests unitaires et d'intégration"],
    ...
    points: ["Node.js, Python, Java", "API REST et GraphQL", "Microservices et serverless", "Bases de données SQL et NoSQL", "Performance et sécurité"],
    ...
    points: ["React Native et Flutter", "iOS et Android natif", "Optimisation pour faible connectivité", "Intégration avec API locales", "Mode hors ligne"],
    ...
    points: ["AWS, Azure, GCP", "Docker et Kubernetes", "CI/CD avec GitHub Actions/Jenkins", "Infrastructure as Code", "Monitoring et observabilité"],
    techStat: `${techStats.serverUptime}% uptime`,
    category: 'cloud'
  }, {
    id: 'data-science',
    ...
    points: ["Analyse prédictive", "Segmentation client", "Détection d'anomalies", "Modélisation statistique", "Data mining"],
    ...
    points: ["Hadoop et Spark", "Streaming de données en temps réel", "Data warehousing", "ETL et pipelines de données", "Data lakes"],
    techStat: `${techStats.apiPerformance}% performance`,
    category: 'data'
  }, {
    id: 'digital-strategy',
    ...
    points: ["Audit digital et benchmarking", "Roadmap de transformation", "Stratégie multicanale", "Indicateurs de performance", "Gouvernance digitale"],
    ...
    points: ["SEO technique et on-page", "SEO local pour marchés africains", "Campagnes Google Ads", "Référencement multilingue", "Analytics et reporting"],
    ...
    points: ["Stratégie de contenu", "Production multiformat", "Calendrier éditorial", "Distribution et amplification", "Mesure de performance"],
    ...
    points: ["Community management", "Social ads ciblées", "Contenu engageant", "Social selling", "Social listening"],
    ...
    points: ["Audit de sécurité", "Implémentation RGPD/GDPR", "Sécurisation des applications", "Gestion des identités", "Formation et sensibilisation"],
    ...
    points: ["Design centré utilisateur", "Tests d'utilisabilité", "Design systems", "Wireframing et prototypage", "Interfaces accessibles"],
    techStat: `${techStats.clientSatisfaction}% satisfaction`,
    category: 'design'
  }, {
    id: 'fintech',
    ...
    points: ["Mobile banking", "Paiements électroniques", "Micro-finance digitale", "Transferts d'argent", "KYC et conformité"],
    ...
    points: ["Smart contracts", "DeFi et tokenisation", "NFT et actifs numériques", "Solutions de traçabilité", "Identité décentralisée"],
    techStat: `${techStats.apiPerformance}% performance`,
    category: 'dev'
  }, {
    id: 'sustainable-tech',
    ...
    points: ["Suivi environnemental par IA", "Applications d'agriculture de précision", "Solutions d'énergie propre", "Gestion intelligente des ressources", "Économie circulaire digitale"],
    ...
    points: ["Chatbots multilingues", "Intégration WhatsApp/Messenger", "IA conversationnelle", "Workflows automatisés", "Analytics conversationnels"],
    ...
    points: ["LMS sur mesure", "Contenu interactif", "Mobile learning", "Évaluation automatisée", "Certification blockchain"],
    techStat: `${techStats.clientSatisfaction}% satisfaction`,
    category: 'dev'
  }, {
    id: 'ecommerce',
    ...
    points: ["Solutions e-commerce sur mesure", "Marketplaces B2B et B2C", "Intégration paiement mobile", "Logistique et livraison du dernier km", "Multicanalité"],
    ...
    points: ["Idéation et validation", "MVP et prototypage rapide", "Business model canvas", "Levée de fonds", "Stratégie de croissance"],
    techStat: `${techStats.projectCompletion}% réussite`,
    category: 'business'
  }, {
    id: 'agile',
    ...
    points: ["Scrum et Kanban", "Product Ownership", "Management visuel", "Équipes distribuées", "Culture de l'amélioration continue"],
    techStat: `${techStats.projectCompletion}% efficacité`,
    category: 'business'
  }, {
    id: 'data-viz',
    ...
    points: ["Dashboards interactifs", "Storytelling visuel", "Infographies personnalisées", "Reportings automatisés", "KPI et métriques"],
    ...
    points: ["API REST et GraphQL", "Documentation OpenAPI", "Intégrations tierces", "API Gateway et sécurité", "Webhooks et événements"],
    techStat: `${techStats.apiPerformance}% performance`,
    category: 'dev'
  }, {
    id: 'iot',
    ...
    points: ["Capteurs et dispositifs connectés", "Edge computing", "Plateformes IoT", "Protocoles de communication", "Analytics IoT"],
    techStat: `${techStats.apiPerformance - 1.3}% fiabilité`,
    category: 'cloud'
  }];

  // Filter expertise areas based on category and search query
  const filteredExpertise = expertiseAreas.filter(item => activeCategory === 'all' || item.category === activeCategory).filter(item => searchQuery === '' || item.title.toLowerCase().includes(searchQuery.toLowerCase()) || item.description.toLowerCase().includes(searchQuery.toLowerCase()) || item.points.some(point => point.toLowerCase().includes(searchQuery.toLowerCase())));
  ...
  return <div className="min-h-screen flex flex-col bg-black text-white relative overflow-hidden">
      {/* Background elements */}
      <SpaceBackground />
      <NebulaBg />
      <TechNodes />
      ...
      <main className="flex-grow z-10 relative">
        <section ref={sectionRef} className="relative py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
            {[{
            label: 'Précision IA',
            value: `${techStats.aiAccuracy}%`
          }, {
            label: 'Uptime Serveurs',
            value: `${techStats.serverUptime}%`
          }, {
            label: 'Complétion Projets',
            value: `${techStats.projectCompletion}%`
          ...
          <div className="mb-10 space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="relative w-full sm:w-96">
                <input type="text" placeholder="Rechercher une expertise..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="w-full px-4 py-2 bg-gray-900/70 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-white placeholder-gray-400" />
              ...
              <Button variant="outline" size="sm" onClick={resetFilters} className="border-gray-700 text-white font-semibold hover:text-white hover:bg-gray-800">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <Button variant={activeCategory === 'all' ? "default" : "outline"} size="sm" onClick={() => setActiveCategory('all')} className={activeCategory === 'all' ? 'bg-cyan-600 text-white font-semibold hover:bg-cyan-700' : 'border-gray-700 bg-gray-800/70 text-white font-semibold hover:bg-gray-700'}>
                Tous
              </Button>
              
              {expertiseCategories.map(category => <Button key={category.id} variant={activeCategory === category.id ? "default" : "outline"} size="sm" onClick={() => setActiveCategory(category.id)} className={`flex items-center gap-1 ${activeCategory === category.id ? 'bg-cyan-600 text-white font-semibold hover:bg-cyan-700' : 'border-gray-700 bg-gray-800/70 text-white font-semibold hover:bg-gray-700'}`}>
                  {category.icon}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredExpertise.slice(0, visibleCount).map(expertise => <motion.div key={expertise.id} initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            duration: 0.4
                ...
                <Card className="h-full overflow-hidden border-0 bg-gradient-to-b from-gray-900 to-gray-950 shadow-xl hover:shadow-primary/10 transition-all duration-300">
                  <CardContent className="p-6 h-full flex flex-col">
                    ...
                    {expertise.description.length > 120 && <button onClick={() => toggleDescription(expertise.id)} className="text-primary text-sm hover:text-primary-dark focus:outline-none mb-4">
                    ...
                    <div className="mt-auto">
                      ...
                      <ul className="space-y-1">
                        {expertise.points.slice(0, 3).map((point, index) => <li key={index} className="flex items-start gap-2 text-sm">
          ...
          {/* Load more button */}
          {filteredExpertise.length > visibleCount && <div className="flex justify-center mt-12">
              <Button onClick={loadMore} className="bg-cyan-600 hover:bg-cyan-700 text-white font-semibold">
