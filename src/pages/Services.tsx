...
const ServicesPage = () => {
  ...
  const filteredServices = searchTerm 
    ? Object.values(allServices).flatMap(category => 
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="relative max-w-xl mx-auto mb-10">
                <Input 
                  ...
                  className="pl-12 bg-black/40 border-gray-700 text-white placeholder:text-gray-400 pr-4 py-6 text-lg"
                  value={searchTerm}
                  ...
                  {filteredServices.length > 0 ? (
                    <ul className="divide-y divide-gray-800">
                      {filteredServices.map((service, index) => (
                        <li key={index} className="p-4 hover:bg-gray-800/40">
